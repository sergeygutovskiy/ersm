		...
		<div class="main-services">
			<div class="block-services">
				...
				<ul>
					...
					<li><a href="services/remont-mest-obshego.php">Ремонт мест общего пользования</a></li>
			...
			<div class="block-services">
				<h3>Проектирование<br> и согласование проектов</h3>
				<br>
				<h3>Ремонт общедомовых<br> инженерных систем</h3>
				<br>
				<h3>Изготовление <br> металлоконструкций</h3>
			</div>
		</div>
	</main>
